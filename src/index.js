...
const moveArray = ['shiftLeft', 'shiftRight', 'shiftUp', 'shiftDown', 'shiftDownRight', 'shiftUpRight', 'shiftUpLeft', 'shiftDownLeft'];
...
turtle.shiftDownRight = function (length=50) {
    turtle.y += length;
    turtle.x += length;
};
turtle.shiftUpRight = function (length=50) {
    turtle.y -= length;
    turtle.x += length;
};
turtle.shiftUpLeft = function (length=50) {
    turtle.y -= length;
    turtle.x -= length;
};
turtle.shiftDownLeft = function (length=50) {
    turtle.y += length;
    turtle.x -= length;
};
